...
async function getData() {
  try {
    const res = await fetch(
      `https://graph.instagram.com/me/media?fields=id,caption,media_url,timestamp,media_type,permalink,username&access_token=${process.env.INSTAGRAM_KEY}`
    );
          ...
          {item.media_type == "IMAGE" && (
            <div
              style={{
                ...
                borderRadius: 10,
                height: "fit-content",
                boxShadow: " 10px 3px 5px -2px rgba(227,84,41,1)",
              }}
            >
              {/* <div style={{ width:"100%"}}> */}
